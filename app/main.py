...
image_path = '/Users/satyapandian/Documents/Projects/word_lens/Word-Lens/app/testdata/test_brush.jpg'
...
definition = get_meaning(overlap_word.lower())
print("overlap_word:", overlap_word)
